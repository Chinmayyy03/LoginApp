...
@WebServlet("/OpenAccount/ALCbDdServlet")
public class ALCbDdServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (productCode == null || productCode.isEmpty()) {
            response.sendRedirect("ALCbDd.jsp?status=error&message=" +
        ...
        PreparedStatement psApp = null, psLoan = null, psCoBorrower = null, psDeposit = null;
        ...
        try {
            ...
            String[] depositSubmissionDates = request.getParameterValues("submissionDate[]");  // Renamed to avoid conflict
            ...
            if (securityTypeCodes != null && securityTypeCodes.length > 0) {
                ...
                for (int i = 0; i < securityTypeCodes.length; i++) {
                    ...
                    // 11. TD_VALUE (NUMBER(15,2), nullable) - Auto-calculated as Security Value × (Margin % / 100)
            ...
            conn.commit();
            response.sendRedirect("ALCbDd.jsp?status=success&applicationNumber=" +
