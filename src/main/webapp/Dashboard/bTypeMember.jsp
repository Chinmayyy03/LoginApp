...
window.onload = function() {
    ...
    if (window.parent && window.parent.buildBreadcrumbPath && window.parent.updateParentBreadcrumb) {
        const breadcrumb = window.parent.buildBreadcrumbPath('Dashboard/bTypeMember.jsp');
        window.parent.updateParentBreadcrumb(breadcrumb, 'Dashboard/bTypeMember.jsp');
    }
...
function viewCustomer(customerId) {
    if (window.parent && window.parent.buildBreadcrumbPath && window.parent.updateParentBreadcrumb) {
        const breadcrumb = window.parent.buildBreadcrumbPath('Dashboard/viewCustomer.jsp', 'Dashboard/bTypeMember.jsp');
