...
<head>
<meta charset="UTF-8">
<title>Other Member - Branch <%= branchCode %></title>
...
function updatePaginationControls(totalRecords, page) {
    ...
    sessionStorage.setItem('otherMemberPage', page);
}
...
window.onload = function() {
    ...
    if (window.parent && window.parent.buildBreadcrumbPath && window.parent.updateParentBreadcrumb) {
        const breadcrumb = window.parent.buildBreadcrumbPath('Dashboard/otherMember.jsp');
        window.parent.updateParentBreadcrumb(breadcrumb, 'Dashboard/otherMember.jsp');
    }
    
    // Check if returning from detail view and restore page
    var savedPage = sessionStorage.getItem('otherMemberPage');
    if (savedPage) {
...
function viewCustomer(customerId) {
    if (window.parent && window.parent.buildBreadcrumbPath && window.parent.updateParentBreadcrumb) {
        const breadcrumb = window.parent.buildBreadcrumbPath('Dashboard/viewCustomer.jsp', 'Dashboard/otherMember.jsp');
        window.parent.updateParentBreadcrumb(breadcrumb, 'Dashboard/viewCustomer.jsp');
    }
    window.location.href = 'viewCustomer.jsp?cid=' + customerId + '&returnPage=otherMember.jsp';
}
</script>
</head>
<body>

<h2>Other Member for Branch: <%= branchCode %></h2>
...
(function() {
    ...
    // Store initial page
    sessionStorage.setItem('otherMemberPage', '1');
})();
</script>
